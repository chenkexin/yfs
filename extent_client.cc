...
extent_client::put(extent_protocol::extentid_t eid, std::string buf)
{
  ...
  int r=0;
  std::cout<<"3"<<endl;
  std::cout<<"trace what cause the call fail"<<endl;
  std::cout<<"the eid:"<<eid<<endl<<"the buf:"<<buf<<endl<<"the r"<<endl;
  std::cout<<"in extent_client::put, the buf size is:"<<buf.size()<<endl;
  r = buf.size();
